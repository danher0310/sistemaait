...
<!-- Modal -->
<div class="modal fade" id="editEquipo" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
  <div class="modal-dialog" role="document">
	...
	<script>
	    ...
	    $("#result").load("assets/php/session/tablaEquipo.php");
	    $(".pagination").bootpag({
	        ...
	        $("#result").load("assets/php/session/tablaEquipo.php", {'page':num});
		    });
